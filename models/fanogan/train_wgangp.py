...
"""
'''
CUDA_VISIBLE_DEVICES=1 python3 train_wgangp.py train --n_epochs 100000 --img_size 768
CUDA_VISIBLE_DEVICES=1 python3 train_encoder_izif.py train --n_epochs 100000 --img_size 768
CUDA_VISIBLE_DEVICES=1 python3 test_anomaly_detection.py anomal --img_size 768
CUDA_VISIBLE_DEVICES=1 python3 save_compared_images.py anomal --img_size 768 --n_iters 0 --n_grid_lines 1
